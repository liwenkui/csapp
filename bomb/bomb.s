...
0000000000400da0 <main>:
  ...
  400e37:	48 89 c7             	mov    %rax,%rdi   //char *input stored in rax
...
0000000000400ee0 <phase_1>:
  ...
  400ee4:	be 00 24 40 00       	mov    $0x402400,%esi//move a const in stack rsp
...
0000000000400efc <phase_2>:
  ...
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers>//if number<6 bomb!
...
0000000000400f43 <phase_3>:
  ...
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx//sec num
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx//sec num
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi// %d %d 
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax
  400f5b:	e8 90 lc ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  400f60:	83 f8 01             	cmp    $0x1,%eax// 
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)//firs num<7(rsp+8) sec(rsp+12)
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>//bomb!
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax//firs
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)//switch(x) x<7
  ...
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax//sec==eax
  400fc2:	74 05                	je     400fc9 <phase_3+0x86>
  400fc4:	e8 71 04 00 00       	callq  40143a <explode_bomb>
  400fc9:	48 83 c4 18          	add    $0x18,%rsp
  400fcd:	c3                   	retq   

0000000000400fce <func4>://fir 0 14
  400fce:	48 83 ec 08          	sub    $0x8,%rsp//local variable
  400fd2:	89 d0                	mov    %edx,%eax//=14
  400fd4:	29 f0                	sub    %esi,%eax//=14
  400fd6:	89 c1                	mov    %eax,%ecx//=14
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx//=0
  400fdb:	01 c8                	add    %ecx,%eax//=14
  400fdd:	d1 f8                	sar    %eax//=7
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx//15
  400fe2:	39 f9                	cmp    %edi,%ecx//fir>15
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx//fir<=15
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>
  400fee:	01 c0                	add    %eax,%eax
  400ff0:	eb 15                	jmp    401007 <func4+0x39>
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax//fir<=15 eax=0;
...
000000000040100c <phase_4>:
  ...
  401029:	83 f8 02             	cmp    $0x2,%eax//succes read two number
  40102c:	75 07                	jne    401035 <phase_4+0x29>
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)//fir<=14
  401033:	76 05                	jbe    40103a <phase_4+0x2e>//0<fir<=14
  401035:	e8 00 04 00 00       	callq  40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx//edx=14;
  40103f:	be 00 00 00 00       	mov    $0x0,%esi//esi=0
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi//edi=fir;
  401048:	e8 81 ff ff ff       	callq  400fce <func4>//eax must be 0
  40104d:	85 c0                	test   %eax,%eax
  40104f:	75 07                	jne    401058 <phase_4+0x4c>
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)//sec = 0
...
0000000000401062 <phase_5>:
  ...
  401067:	48 89 fb             	mov    %rdi,%rbx//input_string to rbx
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
  401078:	31 c0                	xor    %eax,%eax//eax=0
  40107a:	e8 9c 02 00 00       	callq  40131b <string_length>
  40107f:	83 f8 06             	cmp    $0x6,%eax//length = 6
  401082:	74 4e                	je     4010d2 <phase_5+0x70>
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx//fetch character
  40108f:	88 0c 24             	mov    %cl,(%rsp)
  401092:	48 8b 14 24          	mov    (%rsp),%rdx//fetch first char
...
00000000004010f4 <phase_6>:
  ...
  401103:	48 89 e6             	mov    %rsp,%rsi//current frame
  401106:	e8 51 03 00 00       	callq  40145c <read_six_numbers>
  40110b:	49 89 e6             	mov    %rsp,%r14//r14=r13=rbp
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d//counter

  401114:	4c 89 ed             	mov    %r13,%rbp//rsp,rsp+4,rsp+8
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax//num1,num2,num3
  40111b:	83 e8 01             	sub    $0x1,%eax
  40111e:	83 f8 05             	cmp    $0x5,%eax//fir<=6 >0
  401121:	76 05                	jbe    401128 <phase_6+0x34>
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>

  401128:	41 83 c4 01          	add    $0x1,%r12d//1,2,3,4,5,6
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d
  401130:	74 21                	je     401153 <phase_6+0x5f>//jump out of loop
  401132:	44 89 e3             	mov    %r12d,%ebx//ebx 1 2 3 4 5 6

  401135:	48 63 c3             	movslq %ebx,%rax
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax//num2,num3,num4
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)//(num2,num1),(num3,num2)
  40113e:	75 05                	jne    401145 <phase_6+0x51>
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx//2,3,4,5,6,7
  401148:	83 fb 05             	cmp    $0x5,%ebx//2,3,4,5
  40114b:	7e e8                	jle    401135 <phase_6+0x41>
  40114d:	49 83 c5 04          	add    $0x4,%r13//r13
  401151:	eb c1                	jmp    401114 <phase_6+0x20>
  //numbers must diff from each other
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi//num[6]
  401158:	4c 89 f0             	mov    %r14,%rax//=&num[0]
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx//=7
  401160:	89 ca                	mov    %ecx,%edx//=7
  401162:	2b 10                	sub    (%rax),%edx//edx=edx-num[0]
  401164:	89 10                	mov    %edx,(%rax)//num[0]=edx
  401166:	48 83 c0 04          	add    $0x4,%rax//=&num[1]
...
000000000040131b <string_length>:
  40131b:	80 3f 00             	cmpb   $0x0,(%rdi)//compare first character wiht /n
  40131e:	74 12                	je     401332 <string_length+0x17>//if equal jump to bottom
...
0000000000401338 <strings_not_equal>:
  ...
  40133a:	55                   	push   %rbp
  40133b:	53                   	push   %rbx
  40133c:	48 89 fb             	mov    %rdi,%rbx//p1:input_string
  40133f:	48 89 f5             	mov    %rsi,%rbp//p1:pre_rsi:0x402400
  401342:	e8 d4 ff ff ff       	callq  40131b <string_length>
  401347:	41 89 c4             	mov    %eax,%r12d//return length of the string 
...
000000000040145c <read_six_numbers>:
  ...
  401460:	48 89 f2             	mov    %rsi,%rdx//0x7fffffffe5e0
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx//0x7fffffffe5e4
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax//0x7fffffffe5f4
